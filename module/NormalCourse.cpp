...
void NormalCourse::runNormalCourse()
{
  ...
  constexpr std::array<NormalCourseProperty, arraySize> normalCoursePropertyL
      ...
      = { {
          ...
          { 970, baseSpeed - 30, 0.003226, { 0.55, 0.01, 0.2 } },     // 第2区間
          ...
          { 125, baseSpeed, 0.0, { 0.2, 0.05, 0.2 } },                // 第9区間
          ...
          { 505, baseSpeed - 30, -0.004167, { 0.69, 0.005, 0.4 } },   // 第14区間
          { 870, baseSpeed, 0.0, { 0.2, 0.01, 0.2 } },                //進入ライン
          { 850, baseSpeed - 30, -0.00204081, { 0.47, 0.02, 0.2 } },  // ゴール後 カーブ
          { 340, baseSpeed, 0.0, { 0.2, 0.01, 0.4 } },                // ゴール後 第3区間
      } };
